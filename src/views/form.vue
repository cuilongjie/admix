...
export default {
    ...
    methods: {
        init () {
            ...
            this.$set(this, 'detail', { // 初始化值对象绑定，picker类需按对象初始化。Author by clj. on 2018.5.11
                username: '',
                sex: 1,
                studentIdentyType: {key: 3, values: '军人身份证'},
                studentIdentyNo: '', // 证件号码，根据证件类型进行校验、提示，必选。Author by clj. on 2018.6.21
                studentIdentyImages: [], // 证件照，当证件类型非身份证时，必选。Author by clj. on 2018.6.21
                birthday: '2001-02-03',
            ...
            // 初始化组件类型。Author by clj. on 2018.5.11
            ...
            // 设定校验规则，通过key指定validator指令提示的顺序。Author by clj. on 2018.5.16
            ...
            // 证件号码的字段标识必须以'IdengyType'结尾！ Author by clj. on 2018.5.16
            ...
            // 证件号码的校验需要通过证件类型判断，证件号码的字段标识必须以'IdengyNo'结尾，组件内部会找到其对应的证件类型进行选择判断！ Author by clj. on 2018.5.16
